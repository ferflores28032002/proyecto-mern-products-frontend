...
const FormImages = () => {
  ...
  const { addImagenes } = useProducts()

  const { onInputChange, name, description, category, price,  onResetForm } = useForms({
    name: "",
    description: "",
    category: "",
    price:  ""
  ...
  const handlesubmit = (e) => {
    ...
    if (name === "" || description === "" || category === "" || price === "" || e.target.image.files.length === 0) {
